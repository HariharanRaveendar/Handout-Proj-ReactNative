...
import {GetClothData} from '../GetData/GetData';
...
componentDidMount = async () => {
    ...
    const sData = await GetClothData();
    ...
    return(
      <Container>
        <Header>
          ...
          <Body>
            <Title style={{ width: 300, alignItems: 'center' }}>Cloth List</Title>
          </Body>
          <Right />
        </Header>
                    <ScrollView>
                  ...
                  return (
                    <React.Fragment key = {i}>
                        <View style={styles.view}>
                            <Clothcard navigation = {navigation} item = {item}/>
                        </View>
                    </React.Fragment>
                  );   
              }.bind(this))
